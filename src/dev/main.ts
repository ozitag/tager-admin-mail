...
import {EMAIL_LOG_LIST_ROUTE, EMAIL_TEMPLATE_FORM_ROUTE, EMAIL_TEMPLATE_LIST_ROUTE} from '../constants/routes';
...
const router = createRouter(
    {
        routes: [
            EMAIL_LOG_LIST_ROUTE, EMAIL_TEMPLATE_FORM_ROUTE, EMAIL_TEMPLATE_LIST_ROUTE
        ],
    },
    {useTitleSync: false}
);
